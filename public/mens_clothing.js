...
fetch('https://apidojo-forever21-v1.p.rapidapi.com/products/v2/detail?productId=2000449005', options)
...
fetch('https://apidojo-forever21-v1.p.rapidapi.com/products/v2/detail?productId=2000452812', options)
	.then(response => response.json())
	.then(response => {
    console.log(response);
...
fetch('https://apidojo-forever21-v1.p.rapidapi.com/products/v2/detail?productId=2000456929', options)
	.then(response => response.json())
	.then(response => {
    console.log(response);
